# COMPONENT, HOOK, & API DEVELOPMENT RULES — RIO COLLECTION

> **Document Purpose:** Guidelines for component usage & creation, hooks, API routes, performance optimization, SEO, and pre-creation codebase discovery.
