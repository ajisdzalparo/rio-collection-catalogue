    ...
    <>
      ...
      <section className="mx-auto max-w-[1400px] px-4 md:px-16 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16">
          ...
          <div className="md:col-span-7 flex flex-col justify-center">
            <p className="font-[family-name:var(--font-hanken)] text-[16px] md:text-[17px] leading-[1.8] text-(--cat-on-surface-variant)">
            ...
            <p className="mt-6 font-[family-name:var(--font-hanken)] text-[16px] md:text-[17px] leading-[1.8] text-(--cat-on-surface-variant)">
      ...
      <section className="bg-(--cat-surface-container-low)">
        <div className="mx-auto max-w-[1400px] px-4 md:px-16 py-16 md:py-24">
          <h2 className="font-[family-name:var(--font-eb-garamond)] text-[28px] md:text-[36px] font-normal leading-tight text-(--cat-on-surface) text-center mb-14 md:mb-20">
            Nilai Kami
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
            {[
              ...
              <div key={value.title} className="text-center md:text-left">
                <h3 className="font-[family-name:var(--font-hanken)] text-[11px] font-semibold uppercase tracking-[0.08em] text-(--cat-on-surface) mb-4">
                  {value.title}
                </h3>
                <p className="font-[family-name:var(--font-hanken)] text-[15px] leading-relaxed text-(--cat-on-surface-variant)">
                  {value.description}
                </p>
              </div>
            ))}
      ...
      <section className="mx-auto max-w-[1400px] px-4 md:px-16 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          <div>
            <blockquote className="font-[family-name:var(--font-eb-garamond)] text-[24px] md:text-[32px] font-normal leading-snug text-(--cat-on-surface) italic">
              &quot;Kami tidak membuat pakaian. Kami merancang artefak untuk dikenakan.&quot;
            </blockquote>
            <p className="mt-6 font-[family-name:var(--font-hanken)] text-[15px] leading-relaxed text-(--cat-on-surface-variant)">
      ...
      <section className="border-t border-(--cat-stone)">
        <div className="mx-auto max-w-[1400px] px-4 md:px-16 py-16 md:py-20 text-center">
          ...
          <p className="mt-4 font-[family-name:var(--font-hanken)] text-[15px] text-(--cat-on-surface-variant) max-w-md mx-auto">
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="font-[family-name:var(--font-hanken)] text-[14px] text-(--cat-on-surface) underline hover:opacity-70 transition-opacity"
            >
