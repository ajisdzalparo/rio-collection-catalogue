          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16">
            ...
            <div className="md:col-span-5">
              <div className="border border-(--cat-stone) p-6">
                <h2 className="font-[family-name:var(--font-eb-garamond)] text-[20px] font-normal text-(--cat-on-surface) mb-6">
                  Ringkasan Pesanan
                </h2>
                ...
                <div className="flex gap-4 pb-6 border-b border-(--cat-stone)">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="mt-0.5 font-[family-name:var(--font-hanken)] text-[13px] text-(--cat-on-surface-variant)">
                    ...
                    <div className="mt-2 flex items-center justify-between">
                      ...
                      <span className="font-[family-name:var(--font-hanken)] text-[16px] font-medium text-(--cat-on-surface) tabular-nums">
                ...
                <div className="mt-4 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="font-[family-name:var(--font-hanken)] text-[14px] text-(--cat-on-surface-variant)">Subtotal</span>
                    <span className="font-[family-name:var(--font-hanken)] text-[14px] text-(--cat-on-surface) tabular-nums">
                      {product ? formatPrice(product.price) : 'Rp 450.000'}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="font-[family-name:var(--font-hanken)] text-[14px] text-(--cat-on-surface-variant)">Estimasi Pengiriman</span>
                    <span className="font-[family-name:var(--font-hanken)] text-[11px] uppercase tracking-[0.08em] text-(--cat-on-surface-variant)">Dihitung Selanjutnya</span>
                  </div>
                </div>

                <div className="mt-4 pt-4 border-t border-(--cat-stone) flex items-center justify-between">
                  <span className="font-[family-name:var(--font-hanken)] text-[16px] font-semibold text-(--cat-on-surface)">Total</span>
                  <span className="font-[family-name:var(--font-hanken)] text-[18px] font-semibold text-(--cat-on-surface) tabular-nums">
                    {product ? formatPrice(product.price) : 'Rp 450.000'}
                  </span>
                </div>
              </div>
            ...
            <div className="md:col-span-7 space-y-8">
              ...
              <div>
                <label
                  htmlFor="fullName"
                  className="block font-[family-name:var(--font-hanken)] text-[11px] font-semibold uppercase tracking-[0.08em] text-(--cat-on-surface-variant) mb-3"
                >
                  Nama Lengkap
                </label>
                <input
                  ...
                  className="w-full bg-transparent border-0 border-b border-(--cat-stone) pb-2 font-[family-name:var(--font-hanken)] text-[16px] text-(--cat-on-surface) outline-none focus:border-(--cat-charcoal) transition-colors placeholder:text-(--cat-outline-variant)"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-transparent border-0 border-b border-(--cat-stone) pb-2 font-[family-name:var(--font-hanken)] text-[16px] text-(--cat-on-surface) outline-none focus:border-(--cat-charcoal) transition-colors resize-none placeholder:text-(--cat-outline-variant)"
